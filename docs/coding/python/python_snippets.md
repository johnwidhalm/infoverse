...
Invalid value for requires_dist. Error: Can't have direct dependency: 'deepdiff @ git+git://github.com/johnwidhalm/deepdiff@master'
```
...
class PostInstall(install):  # type: ignore
    ...
    def run(self) -> None:
        ...
        install.run(self)
        print(getoutput("pip install git+git://github.com/johnwidhalm/deepdiff@master"))
